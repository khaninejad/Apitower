...
<td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;"></td>
 ...
 @foreach ($feeds as $item)
    <div class="item">
      <h2><a href="{{ $url.'/post/?url='.$item->feed_url.'&feed='.$item->feeds_id.'&domain='.$item->domain()->first()->domain_id }}">{{{ $item->feed_title }}}</a><a href="{{$item->feed_url}}">#</a></h2>
      <p>{!! $item->feed_description !!}</p>
      <p><small>Created on {{ $item->created_at }}</small></p>
    </div>
  @endforeach
  
<a href="{{$url.'/feeds/readall'}}">Read All</a>
...
<td align="center" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
              <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 12px; line-height: 1.6em; color: #666666; font-weight: normal; margin: 0 0 10px; padding: 0;">If you have further question, please contact us: <a href="mailto:support@apitower.com">support@apitower.com</a>. <a href="#">Update subscription</a><br/>
